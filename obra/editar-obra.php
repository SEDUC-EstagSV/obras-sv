    ...
    <section id="servicos" class="caixa">
        ...
        <form action="?page=salvarobra" method="POST">
            ...
            <div class="mb-3">
                ...
                <select class="selectpicker mb-3" id="select" name="usuarios[]" multiple data-live-search="true" title="Selecione usuários responsáveis" data-selected-text-format="count" data-width="auto" data-count-selected-text="Usuários selecionados: {0}">
                    <datalist>
                        <?php
                        try {
